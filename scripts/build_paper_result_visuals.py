...
def build_main_result_table(tables_dir):
    ...
    for row in eval_rows:
        ...
        rows.append({
            ...
            "eval_protocol": "sampled_periodic_diagnostic_eval",
            "psnr_mean": row.get("psnr_mean", ""),
            "psnr_median": row.get("psnr_median", ""),
            "l1_mean": row.get("l1_mean", ""),
            "ssim_mean": "",
...
def plot_eval_curves(eval_rows, out_dir, metric, ylabel):
    ...
    ax.set_title("Sampled periodic diagnostic eval")
...
def main():
    ...
    readme = (
        ...
        "## Tables\n\n"
        "- `tables/table_main_results.md`: compact result table for paper drafting; prefers full final evaluation and falls back to sampled periodic diagnostic eval only when full final evaluation is missing.\n"
        ...
        "## Plots\n\n"
        "- `plots/psnr_mean_curve.png` (sampled periodic diagnostic)\n"
